...
#ifdef ALLOW_HYBRID_WIND_STRESS
C--   COMMON /AUTODIFF_PARM_R2/ "Real" valued parameters used by the pkg.
C     HybWindStressFacInAd  :: hybrid wind stress factor for adjoint
C     HybWindStressFacInFw  :: hybrid wind stress factor for forward model
      _RL HybWindStressFacInAd, HybWindStressFacInFw
      COMMON /AUTODIFF_PARM_R2/
     &  HybWindStressFacInAd, HybWindStressFacInFw
#endif
