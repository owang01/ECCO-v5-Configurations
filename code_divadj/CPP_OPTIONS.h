...
C o Use hybrid wind stress that will compute adjoint sensitivities
C   for both wind stress and wind vectors. Normally, the MITgcm 
C   will read in either wind stress or wind vectors, but not both. 
C   The CPP option ALLOW_HYBRID_WIND_STRESS allows both can be read
C   in. In the forward or recomputation, it uses wind stress 
C   (and wind speed) to compute wind vectors to reproduce ECCO V4r5.
C   However, during adjoint computations, wind vector is used to 
C   compute wind stress and therefore calculate the sensitivites 
C   to wind vector. 
#define ALLOW_HYBRID_WIND_STRESS

C o Simple code to calculate cost without integrating the model
#undef SIMPLE_CODE

C o Turn off capping of precip with snowprecip. This will elimnate one
